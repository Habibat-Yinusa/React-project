...
function Navbar() {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
        <h1 className='w-full text-3xl font-bold text-[#eb8715]'>REACT</h1>
        ...
        <div className= {nav ? 'fixed left-0 top-0 h-full w-3/5 border-r border-r-gray-900 bg-[#010831] ease-in-out duration-500': 'fixed left-[-100%]'} >
        <h1 className='w-full text-3xl font-bold text-[#eb8715] m-4' >REACT</h1>
